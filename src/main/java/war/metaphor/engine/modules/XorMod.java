...
public class XorMod implements Module {
    ...
    public String getSourceInstructions(Context context) {
        return "(_mm_cvtsi128_si32(_mm_xor_si128(_mm_set1_epi32(((julong)" + context.varName + ")), _mm_set1_epi32((julong)" + context.popStack() + "))))";
    }
